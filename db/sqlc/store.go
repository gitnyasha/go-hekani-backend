...
type Store interface {
	Querier
	RelationshipTx(ctx context.Context, arg RelationshipTxParams) (RelationshipTxResult, error)
}
...
func (store *SQLStore) RelationshipTx(ctx context.Context, arg RelationshipTxParams) (RelationshipTxResult, error) {
